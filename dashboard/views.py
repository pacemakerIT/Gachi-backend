...
def dashboard_api_design(request):
    ...
    for topic in topics:
        ...
        for program_topic in topic_programs:
            program_id = program_topic.programid
            participants = Programparticipants.objects.filter(programid=program_id)
    ...
    topic_participation_data = sorted(topic_participation_data, key=lambda x: x["participation_count"], reverse=True)[:5]
    ...
    for month in sales_months:
        ...
        monthly_sales_data.append({
            ...
            "free_participation_count": free_count
        })
    ...
    data = {
        ...
        "current_monthly_new_users": current_monthly_new_users,
        "total_users": total_users,
        "growth_rate": f"{growth_rate:.1f}%",
        "popular_mentors": popular_mentors,
        "popular_programs": popular_programs,
        "total_participation_count": total_participation_count,
        "topic_participation_data": topic_participation_data,
        "industry_participation": industry_data,
        "year": current_year,
        "monthly_inflow_data": monthly_inflow_data,
