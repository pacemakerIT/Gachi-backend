...
def landing_page_supabase_connection(request):
    ...
    response_mentor = supabase.table('User').select('photoUrl, firstName, lastName, userId, Industry!inner(title)').eq('userTypeId', '55181db3-e2e6-4561-9a4e-0387f6df0782').execute()
